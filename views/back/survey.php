  ...
  <section id="container">
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              <div class="notify-arrow notify-arrow-green"></div>
              <li>
                <p class="green">You have 5 new types</p>
              </li>
              <li>
                <a href="index.html#">
              ...
              <li>
                <a href="index.html#">See all types
                  </a>
              </li>
            </ul>
          </li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Survey</h3>
        <a href="ajoutersurvey.php"><button type="button" class="btn btn-primary">ajouter survey</button></a>
        <?PHP
include "../../core/surveyC.php";
include "../../core/reponseC.php";
$survey1C=new surveyC();
$listesurveys=$survey1C->affichersurveys();
include "chartjs-conf.php";
//var_dump($listesurveys->fetchAll());
?>
        <!-- row -->
        <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i>survey</h4>
                <hr>
                <thead>
                  <tr>
                    <th>id survey</th>
	            ...
	            ?>
                  <tr>
                    ...
                    <td>
                  <a href="modifiersurvey.php?ids=<?php echo $row['ids']; ?>"><button class="btn btn-warning btn-xs">modifier</button></a>  
                       
                    </td>

                    <td>
                      <a href="supprimersurvey.php?ids=<?php echo $row['ids']; ?>"><button class="btn btn-danger btn-xs">supprimer</button></a>
                    </td>
                    <td>
                    <form method="POST" >
                        <button name="stat" class="btn btn-info" data-toggle="modal" data-target="#exampleModal" >statistique</button>
                        <input name="ids" value="<?PHP echo $row['ids']; ?>" >
                    </form>
                    </td>
                  </tr>
                  <?PHP
            ...
            <div class="col-lg-0" hidden>
              <div class="content-panel">
                ...
                <div class="panel-body text-center">
                  <canvas id="bar" height="0" width="0" ></canvas>
                </div>
              </div>
            </div>
            <div class="col-lg-12">
                ...
                <div class="panel-body text-center">
                  ...
                  <?php
                          ...
                          if(isset($_POST['stat'])){
                              ...
                              $result1=$reponseC->calculeroui($_POST['ids']);
                              $result2=$reponseC->calculernon($_POST['ids']);
                              $totale=($result1+$result2);
                              $result1=(($result1*100)/$totale);
                              $result2=(($result2*100)/$totale);
                          }
                      ?> 
                  <span id="result1" hidden><?php echo $result1;?></span>
                  <span id="result2" hidden><?php echo $result2;?></span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row mt" hidden>
            <div class="col-lg-0">
              <div class="content-panel">
                ...
                <div class="panel-body text-center">
                  <canvas id="doughnut" height="0" width="0" ></canvas>
                </div>
              </div>
            </div>
            <div class="col-lg-0" >
              <div class="content-panel">
                ...
                <div class="panel-body text-center">
                  <canvas id="line" height="0" width="0" ></canvas>
                </div>
              </div>
            </div>
          </div>
          <div class="row mt" hidden>
            <div class="col-lg-0">
              <div class="content-panel">
                ...
                <div class="panel-body text-center">
                  <canvas id="radar" height="0" width="0" ></canvas>
                </div>
              </div>
            </div>
            <div class="col-lg-0">
              <div class="content-panel">
                ...
                <div class="panel-body text-center">
                  <canvas id="polarArea" height="0" width="0" ></canvas>
                </div>
              </div>
            </div>
          </div>
