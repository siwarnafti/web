...
<body>
  <section id="container">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li>
                <a href="index.html#">
                  <div class="task-info">
                    <div class="desc">survey Development</div>
    ...
    <section id="main-content">
      ...
      <a href="survey.php"><button type="button" class="btn btn-primary">afficher surveys</button></a>
        <h3><i class="fa fa-angle-right"></i> ajouter survey</h3>
        <!-- BASIC FORM VALIDATION -->
        <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i> ajouter survey</h4>
            <div class="form-panel">
              <form method="POST" action="ajoutsurvey.php" role="form" class="form-horizontal style-form">
                <div class="form-group">
                  <label class="col-lg-2 control-label">survey name</label>
                  <div class="col-lg-10">
                    <input type="text" placeholder="" id="nom" name="nom" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-lg-2 control-label">question</label>
                  <div class="col-lg-10">
                    <input type="text" placeholder="" id="question" name="question" class="form-control">
                  </div>
                </div>
                <div class="form-group">
