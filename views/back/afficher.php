  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>SAV</h3>
        <?PHP
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i>Reclamation</h4>
                <hr>
                <thead>
                  <tr>
	            ...
	            ?>
                  <tr>
                    ...
                    <td>
                    <?PHP if($row['confirmer']==0){
                        ?><a href="modifierreclamation.php?id_reclamation=<?php echo $row['id_reclamation']; ?>"><button class="btn btn-warning btn-xs">NON</button></a>  <?PHP ;}
                        else{?> <button class="btn btn-success btn-xs">OUI</button> <?PHP ;} ?> 
                    </td>

                    <td>
                      <a href="supprimerreclamation.php?id_reclamation=<?php echo $row['id_reclamation']; ?>"><button class="btn btn-danger btn-xs">supprimer</button></a>
                    </td>
                  </tr>
                  <?PHP
                        }
